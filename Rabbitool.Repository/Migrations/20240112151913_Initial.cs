...
namespace Rabbitool.Repository.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BilibiliSubscribe_QQChannelSubscribe",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BilibiliSubscribe_QQChannelSubscribe", x => new { x.BilibiliSubscribesId, x.QQChannelsId });
                    table.ForeignKey(
                        name: "FK_BilibiliSubscribe_QQChannelSubscribe_BilibiliSubscribe_BilibiliSubscribesId",
                        column: x => x.BilibiliSubscribesId,
                        principalTable: "BilibiliSubscribe",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BilibiliSubscribe_QQChannelSubscribe_QQChannelSubscribe_QQChannelsId",
            ...
            migrationBuilder.CreateTable(
                name: "MailSubscribe_QQChannelSubscribe",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MailSubscribe_QQChannelSubscribe", x => new { x.MailSubscribesId, x.QQChannelsId });
                    table.ForeignKey(
                        name: "FK_MailSubscribe_QQChannelSubscribe_MailSubscribe_MailSubscribesId",
                        column: x => x.MailSubscribesId,
                        principalTable: "MailSubscribe",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MailSubscribe_QQChannelSubscribe_QQChannelSubscribe_QQChannelsId",
                        column: x => x.QQChannelsId,
                        principalTable: "QQChannelSubscribe",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "TwitterSubscribe_QQChannelSubscribe",
                columns: table => new
                {
                    QQChannelsId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TwitterSubscribe_QQChannelSubscribe", x => new { x.QQChannelsId, x.TwitterSubscribesId });
                    table.ForeignKey(
                        name: "FK_TwitterSubscribe_QQChannelSubscribe_QQChannelSubscribe_QQChannelsId",
                        column: x => x.QQChannelsId,
                        principalTable: "QQChannelSubscribe",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TwitterSubscribe_QQChannelSubscribe_TwitterSubscribe_TwitterSubscribesId",
            ...
            migrationBuilder.CreateTable(
                name: "YoutubeSubscribe_QQChannelSubscribe",
                columns: table => new
                {
                    QQChannelsId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YoutubeSubscribe_QQChannelSubscribe", x => new { x.QQChannelsId, x.YoutubeSubscribesId });
                    table.ForeignKey(
                        name: "FK_YoutubeSubscribe_QQChannelSubscribe_QQChannelSubscribe_QQChannelsId",
                        column: x => x.QQChannelsId,
                        principalTable: "QQChannelSubscribe",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_YoutubeSubscribe_QQChannelSubscribe_YoutubeSubscribe_YoutubeSubscribesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BilibiliSubscribe_QQChannelSubscribe_QQChannelsId",
                table: "BilibiliSubscribe_QQChannelSubscribe",
                column: "QQChannelsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MailSubscribe_QQChannelSubscribe_QQChannelsId",
                table: "MailSubscribe_QQChannelSubscribe",
                column: "QQChannelsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TwitterSubscribe_QQChannelSubscribe_TwitterSubscribesId",
                table: "TwitterSubscribe_QQChannelSubscribe",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_YoutubeSubscribe_QQChannelSubscribe_YoutubeSubscribesId",
                table: "YoutubeSubscribe_QQChannelSubscribe",
