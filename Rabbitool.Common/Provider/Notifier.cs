...
public class Notifier : ILogEventSink, IDisposable
{
    ...
    private readonly List<ErrorCounter> _errors = [];
    ...
    public Notifier(NotifierOptions opts, IFormatProvider? formatProvider = null)
    {
...
public class ErrorCounter(string text, long timeStampToReset, long timeout)
{
    public int Count { get; set; }
    public string Text { get; set; } = text;
    public long TimeStampToReset { get; set; } = timeStampToReset;
...
public static class NotifierExtension
{
    ...
    {
        return loggerConfiguration.Sink(new Notifier(notifierOptions, formatProvider));
    }
}